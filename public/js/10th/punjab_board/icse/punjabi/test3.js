...
const questions = [
        ...
        {
                "num": 1,
                "question_en": "Which of these is a famous Punjabi folk song?",
                "question_pa": "ਇਹਨਾਂ ਵਿੱਚੋਂ ਕਿਹੜਾ ਪੰਜਾਬੀ ਲੋਕ ਗੀਤ ਹੈ?",
                "options_en": ["Jugni", "Gurbani", "Bhajan", "Qawwali"],
                "options_pa": ["ਜੁਗਨੀ", "ਗੁਰਬਾਣੀ", "ਭਜਨ", "ਕਵਾਲੀ"],
                "answer_en": "Jugni",
                "answer_pa": "ਜੁਗਨੀ"
        },
        {
                "num": 2,
                "question_en": "What is the feminine form of 'ਮੁੰਡਾ' (Boy)?",
                "question_pa": "'ਮੁੰਡਾ' ਦੀ ਸਤਰੀ ਲਿੰਗ ਰੂਪ ਕੀ ਹੈ?",
                "options_en": ["ਕੁੜੀ", "ਮੁੰਡੀ", "ਬੇਟੀ", "ਭੈਣ"],
                "options_pa": ["ਕੁੜੀ", "ਮੁੰਡੀ", "ਬੇਟੀ", "ਭੈਣ"],
                "answer_en": "ਕੁੜੀ",
                "answer_pa": "ਕੁੜੀ"
        },
        {
                "num": 3,
                "question_en": "Who wrote the epic 'Heer Ranjha'?",
                "question_pa": "'ਹੀਰ ਰਾਂਝਾ' ਮਹਾਂਕਾਵਿ ਕਿਸ ਨੇ ਲਿਖਿਆ?",
                "options_en": ["Waris Shah", "Bulleh Shah", "Shiv Kumar Batalvi", "Amrita Pritam"],
                "options_pa": ["ਵਾਰਿਸ ਸ਼ਾਹ", "ਬੁੱਲ੍ਹੇ ਸ਼ਾਹ", "ਸ਼ਿਵ ਕੁਮਾਰ ਬਟਾਲਵੀ", "ਅਮ੍ਰਿਤਾ ਪ੍ਰੀਤਮ"],
                "answer_en": "Waris Shah",
                "answer_pa": "ਵਾਰਿਸ ਸ਼ਾਹ"
        },
        {
                "num": 4,
        ...
        {
                "num": 10,
                "question_en": "Which Punjabi writer wrote 'Pariwarh'?",
                "question_pa": "'ਪਰਿਵਾਰ' ਕਿਸ ਪੰਜਾਬੀ ਲੇਖਕ ਨੇ ਲਿਖਿਆ?",
        ...
        {
                "num": 11,
                "question_en": "What is the correct spelling for 'Sun' in Punjabi?",
                "question_pa": "'ਸੂਰਜ' ਦੀ ਸਹੀ ਸਪੈਲਿੰਗ ਕਿਹੜੀ ਹੈ?",
                "options_en": ["ਸੂਰਜ", "ਸੂਰਜਿ", "ਸੂਰਜੀ", "ਸੂਰਜੇ"],
                "options_pa": ["ਸੂਰਜ", "ਸੂਰਜਿ", "ਸੂਰਜੀ", "ਸੂਰਜੇ"],
                "answer_en": "ਸੂਰਜ",
                "answer_pa": "ਸੂਰਜ"
        },
        {
                ...
                "options_en": ["Algoza", "Sitar", "Tabla", "Harmonium"],
                "options_pa": ["ਅਲਗੋਜ਼ਾ", "ਸਿਤਾਰ", "ਤਬਲਾ", "ਹਾਰਮੋਨੀਅਮ"],
                "answer_en": "Algoza",
                "answer_pa": "ਅਲਗੋਜ਼ਾ"
        },
        {
                "num": 13,
                "question_en": "Who is the author of 'Ik Kudi Jida Naam Mohabbat'?",
                "question_pa": "'ਇੱਕ ਕੁੜੀ ਜਿਦਾ ਨਾਮ ਮੋਹੱਬਤ' ਦੇ ਲੇਖਕ ਕੌਣ ਹਨ?",
        ...
        {
                "num": 14,
                "question_en": "What is the meaning of 'ਪ੍ਰੇਮ' in English?",
                "question_pa": "'ਪ੍ਰੇਮ' ਦਾ ਅੰਗਰੇਜ਼ੀ ਵਿੱਚ ਕੀ ਅਰਥ ਹੈ?",
                "options_en": ["Love", "Hate", "Joy", "Sorrow"],
                "options_pa": ["ਪਿਆਰ", "ਨਫ਼ਰਤ", "ਖੁਸ਼ੀ", "ਦੁੱਖ"],
                "answer_en": "Love",
                "answer_pa": "ਪਿਆਰ"
        },
        {
                "num": 15,
                "question_en": "Which tense is 'ਮੈਂ ਪੜ੍ਹ ਰਿਹਾ ਹਾਂ' in?",
                "question_pa": "'ਮੈਂ ਪੜ੍ਹ ਰਿਹਾ ਹਾਂ' ਕਿਹੜੇ ਕਾਲ ਵਿੱਚ ਹੈ?",
        ...
        {
                "num": 16,
                "question_en": "Who wrote 'Kali Teer'?",
                "question_pa": "'ਕਾਲੀ ਤੀਰ' ਕਿਸ ਨੇ ਲਿਖਿਆ?",
                "options_en": ["Dalip Kaur Tiwana", "Amrita Pritam", "Nanak Singh", "Gurdial Singh"],
                "options_pa": ["ਦਲੀਪ ਕੌਰ ਤਿਵਾਣਾ", "ਅਮ੍ਰਿਤਾ ਪ੍ਰੀਤਮ", "ਨਾਨਕ ਸਿੰਘ", "ਗੁਰਦਿਆਲ ਸਿੰਘ"],
                "answer_en": "Dalip Kaur Tiwana",
                "answer_pa": "ਦਲੀਪ ਕੌਰ ਤਿਵਾਣਾ"
        },
        {
                "num": 17,
                "question_en": "What is the plural of 'ਗਾਂ' (Cow)?",
                "question_pa": "'ਗਾਂ' ਦਾ ਬਹੁਵਚਨ ਕੀ ਹੈ?",
                "options_en": ["ਗਾਂਵਾਂ", "ਗਾਵਾਂ", "ਗਾਈਆਂ", "ਗਾਵੇ"],
                "options_pa": ["ਗਾਂਵਾਂ", "ਗਾਵਾਂ", "ਗਾਈਆਂ", "ਗਾਵੇ"],
                "answer_en": "ਗਾਵਾਂ",
                "answer_pa": "ਗਾਵਾਂ"
        },
        {
                "num": 18,
                "question_en": "Which Punjabi poet wrote 'Luna'?",
                "question_pa": "'ਲੂਣਾ' ਕਿਸ ਕਵੀ ਦੀ ਰਚਨਾ ਹੈ?",
                "options_en": ["Shiv Kumar Batalvi", "Amrita Pritam", "Pash", "Surjit Patar"],
                "options_pa": ["ਸ਼ਿਵ ਕੁਮਾਰ ਬਟਾਲਵੀ", "ਅਮ੍ਰਿਤਾ ਪ੍ਰੀਤਮ", "ਪਾਸ਼", "ਸੁਰਜੀਤ ਪਾਤਰ"],
                "answer_en": "Shiv Kumar Batalvi",
                "answer_pa": "ਸ਼ਿਵ ਕੁਮਾਰ ਬਟਾਲਵੀ"
        ...
        },
        {
                ...
                "options_en": ["Sassi Punnu", "Panchatantra", "Jataka Tales", "Hitopadesha"],
                "options_pa": ["ਸੱਸੀ ਪੁੰਨੂੰ", "ਪੰਚਤੰਤਰ", "ਜਾਤਕ ਕਥਾਵਾਂ", "ਹਿਤੋਪਦੇਸ਼"],
        ...
        {
                "num": 22,
                "question_en": "Which tense is 'ਮੈਂ ਖਾਵਾਂਗਾ' in?",
                "question_pa": "'ਮੈਂ ਖਾਵਾਂਗਾ' ਕਿਹੜੇ ਕਾਲ ਵਿੱਚ ਹੈ?",
        ...
        {
                "num": 23,
                "question_en": "Who is the author of 'Agg Diyan Likkaran'?",
                "question_pa": "'ਅੱਗ ਦੀਆਂ ਲਿਖਾਰਨ' ਦੇ ਲੇਖਕ ਕੌਣ ਹਨ?",
                "options_en": ["Amrita Pritam", "Nanak Singh", "Kartar Singh Duggal", "Dalip Kaur Tiwana"],
                "options_pa": ["ਅਮ੍ਰਿਤਾ ਪ੍ਰੀਤਮ", "ਨਾਨਕ ਸਿੰਘ", "ਕਰਤਾਰ ਸਿੰਘ ਦੁੱਗਲ", "ਦਲੀਪ ਕੌਰ ਤਿਵਾਣਾ"],
        ...
        {
                "num": 25,
                "question_en": "Which Punjabi poet wrote 'Main Te Main'?",
                "question_pa": "'ਮੈਂ ਤੇ ਮੈਂ' ਕਿਸ ਕਵੀ ਦੀ ਰਚਨਾ ਹੈ?",
        ...
        {
                "num": 26,
                "question_en": "What is the feminine form of 'ਬਾਪੂ' (Father)?",
                "question_pa": "'ਬਾਪੂ' ਦੀ ਸਤਰੀ ਲਿੰਗ ਰੂਪ ਕੀ ਹੈ?",
                "options_en": ["ਮਾਂ", "ਭੈਣ", "ਬੇਟੀ", "ਦਾਦੀ"],
                "options_pa": ["ਮਾਂ", "ਭੈਣ", "ਬੇਟੀ", "ਦਾਦੀ"],
                "answer_en": "ਮਾਂ",
                "answer_pa": "ਮਾਂ"
        },
        {
        ...
        {
                "num": 28,
                "question_en": "What is the meaning of 'ਸਾਦਗੀ' in English?",
                "question_pa": "'ਸਾਦਗੀ' ਦਾ ਅੰਗਰੇਜ਼ੀ ਵਿੱਚ ਕੀ ਅਰਥ ਹੈ?",
                "options_en": ["Simplicity", "Happiness", "Wealth", "Courage"],
                "options_pa": ["ਸਾਦਗੀ", "ਖੁਸ਼ੀ", "ਧਨ", "ਹਿੰਮਤ"],
